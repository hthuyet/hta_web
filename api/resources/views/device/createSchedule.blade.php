...
<div class="box">
    ...
    <div class="box-body">
        {!! Form::open(array("id" => "frmForm",'route' => ['device.schedule',"id"=>$device->id], 'method' => 'POST','onsubmit' => 'return onSubmit(this);')) !!}
