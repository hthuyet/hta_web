...
angular.module('BlurAdmin.pages.irrigation').controller('HistoryModalCtrl', [
    '$scope', '$uibModalInstance', '$uibModal', 'IrrService', 'item', 'lstDevice', 'toastr',
    'toastrConfig', '$filter', 'editableOptions', 'editableThemes'
            , function ($scope, $uibModalInstance, $uibModal, IrrService, item, lstDevice, toastr, toastrConfig,
