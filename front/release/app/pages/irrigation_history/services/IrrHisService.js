(function () {
    ...
    angular
            .module('BlurAdmin')
            .factory('IrrHisService', IrrHisService);

    function IrrHisService($http) {
        var service = {};
        ...
        function loadData(area_id, params, callback) {
            $http.get(constAcl.API_URL + '/api/area_irrigation/' + area_id, params)
